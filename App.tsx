...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-brand-bg min-h-screen text-brand-text font-sans selection:bg-brand-orange selection:text-white">
      {/* Main Content Area */}
      <main className="max-w-md mx-auto min-h-screen bg-brand-bg shadow-2xl relative overflow-hidden" style={{ transform: 'scale(0.92)', transformOrigin: 'top center' }}>
        ...
        {/* Bottom Navigation */}
        <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-slate-900/90 backdrop-blur-xl border-t border-slate-800 h-20 pb-4 z-50" style={{ transform: 'scale(0.92)', transformOrigin: 'bottom center' }}>
